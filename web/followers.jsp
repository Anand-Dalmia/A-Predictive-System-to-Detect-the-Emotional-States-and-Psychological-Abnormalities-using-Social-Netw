...
<html lang="en">
    ...
    <head>
        ...
        <title>A Predictive System to Detect the Emotional States and Psychological Abnormalities using Social Networks
</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                        <h1>A Predictive System to Detect 
                            the Emotional States and Psychological 
